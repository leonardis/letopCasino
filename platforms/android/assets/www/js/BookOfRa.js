      ...
      case 8: // check results
        ...
        if (percent) {
          ...
          if ((books >= 4) && !free) {
            ...
            if (itemRand == 1){
              imageRand = "1q";
              $('#bonusImage').attr("src","img/BookOfRa/1q.png");
            }if (itemRand == 2){
              imageRand = "esc";
              $('#bonusImage').attr("src","img/BookOfRa/esc.png");
            }if (itemRand == 3){
              imageRand = "far";
              $('#bonusImage').attr("src","img/BookOfRa/far.png");
            }if (itemRand == 4){
              imageRand = "indi";
              $('#bonusImage').attr("src","img/BookOfRa/indi.png");
            }if (itemRand == 5){
              imageRand = "j";
              $('#bonusImage').attr("src","img/BookOfRa/j.png");
            }if (itemRand == 6){
              imageRand = "k";
              $('#bonusImage').attr("src","img/BookOfRa/k.png");
            }if (itemRand == 7){
              imageRand = "q";
              $('#bonusImage').attr("src","img/BookOfRa/q.png");
            }if (itemRand == 8){
              imageRand = "raa";
              $('#bonusImage').attr("src","img/BookOfRa/raa.png");
            }if (itemRand == 9){
              imageRand = "a";
              $('#bonusImage').attr("src","img/BookOfRa/a.png");
            }
